...
pic=df.plot.line()
pic=pic.get_figure()
pic.savefig('C:/Users/abdul\PycharmProjects\pythonProject\skill exercises')
...
plt.pie(y,labels=mylabels,startangle=20)
plt.show()
...
if __name__ == "__main__":
    file_path = "csf.csv"
    data_frame = read_csv_file("C:/Users/abdul\Downloads\csf.csv")
